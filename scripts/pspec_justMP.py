...
psk_vx, freqs = reader3d.psProfileMean_justMP(do3d, 'rootRhoDvx', nStart=nStart, nEnd=nEnd)
psk_vy, freqs = reader3d.psProfileMean_justMP(do3d, 'rootRhoDvy', nStart=nStart, nEnd=nEnd)
psk_vz, freqs = reader3d.psProfileMean_justMP(do3d, 'rootRhoDvz', nStart=nStart, nEnd=nEnd)
