...
def makeAnimFrame(self, n):
	...
	for key in ['vx', 'vy', 'vz']:
		...
		aspect  = 0.84
		plotData = prepPlotData(data2d, -limBase*5.0, limBase*5.0)
		cmapType = 'coolwarm'
	...
	data2d = data3d[:,:,do3d.nz//2]
	extent = [-do3d.xmax, do3d.xmax, -do3d.ymax, do3d.ymax]
	plotData = prepPlotData(data2d, -2.e-2, 2.e-2)
	cmapType = 'PuOr'
	ax[axNum].imshow(plotData, extent=extent, aspect=aspect, cmap=plt.get_cmap(cmapType))
	...
	extent = [-do3d.xmax, do3d.xmax, -do3d.ymax, do3d.ymax]
	plotData = prepPlotData(data2d, 1.e-1, 3.0)
	cmapType = 'viridis'
	ax[axNum].imshow(plotData, extent=extent, aspect=aspect, cmap=plt.get_cmap(cmapType))
	...
	extent = [-do3d.xmax, do3d.xmax, -do3d.zmax, do3d.zmax]
	plotData = prepPlotData(data2d, 1.e-1, 6.0)
	cmapType = 'viridis'
	ax[axNum].imshow(plotData, extent=extent, aspect=aspect, cmap=plt.get_cmap(cmapType))
